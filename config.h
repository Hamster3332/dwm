...
static const char *fonts[]          = { "JetBrainsMono Nerd Font Mono:style=SemiBold:size=14" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font Mono:style=SemiBold:size=14";
