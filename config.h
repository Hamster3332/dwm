...
static const int refreshrate =
    165; /* refresh rate (per second) for client move/resize */
...
static const char *dmenucmd[] = {
    ...
    col_gray3,   "-sb", col_green1, "-sf", col_gray4, NULL};
...
static const Key keys[] = {
    ...
    {0, XK_Print, spawn,
     SHCMD("flameshot gui -r | xclip -selection clipboard -t image/png")},
